...
def run_operations(client_message):
    ...
    if li[0] == 'oper' and li[2] == 'stat' and li[3] == 'dodawanie' and li[4] == li[6] == li[8] == 'numb':
        result = int(li[5]) + int(li[7]) + int(li[9])
        return 'Wynikiem operacji jest %s' %result

    elif li[0] == 'oper' and li[2] == 'stat' and li[3] == 'mnozenie' and li[4] == li[6] == li[8] == 'numb':
        result = int(li[5]) * int(li[7]) * int(li[9])
        return 'Wynikiem operacji jest %s' % result

    elif li[0] == 'oper' and li[2] == 'stat' and li[3] == 'odejmowanie' and li[4] == li[6] == li[8] == 'numb':
        result = int(li[5]) - int(li[7]) - int(li[9])
        return 'Wynikiem operacji jest %s' % result

    elif li[0] == 'oper' and li[2] == 'stat' and li[3] == 'dzielenie' and li[4] == li[6] == li[8] == 'numb':
        result = int(li[5]) / int(li[7]) / int(li[9])
        return 'Wynikiem operacji jest %s' % result
